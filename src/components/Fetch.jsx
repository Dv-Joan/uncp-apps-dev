  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex items-center justify-center gap-3">
        ...
        <span className="px-3 mt-1 font-semibold bg-yellow-200 border-[1px] border-yellow-700 text-yellow-600 rounded-full text-md">
          week 4
        </span>
        <h1 className="my-10 text-3xl font-bold tracking-tight"> Fetch</h1>
        <hr className="w-96 h-0.5 my-8 bg-gray-200 border-0 rounded dark:bg-gray-500" />
      </div>
      {loading && <p>Loading...</p>}
      {error && <p>Error :(</p>}

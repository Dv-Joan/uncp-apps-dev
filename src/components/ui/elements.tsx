    ...
    return (
        <div className=" dropdown">
            ...
            <ul tabIndex={0} className="p-10 shadow cursor-default textt-lef dropdown-content menu bg-base-100 rounded-box ">
                <li>{weeklyGoals}</li>
                <li className='min-w-[500px] pt-10 text-xl text-center'> Proyecto de la semana
                    {weeklyProject} </li>
...
export function Goals({ weeklyClassDescription, weeklyGoalOne, weeklyGoalTwo, weeklyGoalThree }) {
    return (

        <div className="cursor-default card-body " >
            <h3 className="card-title">Descripcion</h3>
            <p className='px-5 text-neutral-content'>{weeklyClassDescription} </p>
            <h3 className="pt-10 card-title">Logros</h3>
